...
![image](/assets/img/posts/2022-07-18-Heap-28efc575.png)
...
![image](/assets/img/posts/2022-07-18-Heap-6b8511d2.png)

### 우선순위 큐

일반적인 큐와 다르게 우선순위 큐에서는 `front`가 아니라 아래의 그림처럼 우선순위가 높은 데이터가 가장 먼저 나오게 되는 차이점이 있습니다.

![image](/assets/img/posts/2022-07-18-Heap-66a0a880.png)
...
![image](/assets/img/posts/2022-07-18-Heap-4989dddc.png)

### 최소 힙(Min Heap)

부모 노드의 키 값이 자식 노드의 키 값보다 항상 **작은** 형태를 가집니다.

![image](/assets/img/posts/2022-07-18-Heap-260f8193.png)

## 구현

힙은 완전 이진트리 성질을 만족하기 때문에 다음처럼 1차원 배열(array)로도 표현이 가능합니다.

![image](/assets/img/posts/2022-07-18-Heap-a7b25b1c.png)
